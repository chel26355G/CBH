...
<div class="caption">     
						...
						<div class="form-group">
							<input type="submit" class="btn btn-secondary w-100" value="아이디찾기" onclick="retrun checkErrCode()" style="margin-top: 50px;margin-left: 0px;padding-left: 180px;padding-right: 165px;margin-right: 0px;" />
