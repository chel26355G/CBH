...
<body onload="errCodeCheck()" style="background:#FFFFFF;">
<nav class="navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/bbs/">야옹</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li style=""><a href="/bbs/board/list.do">게시판</a></li>
					<!--
					<article class="right">
...
<div class="wrapper">	
	<table class="table table-hober">
		<tr>
			<th>${board.title} &nbsp;${board.regDate}</th>
			<th style="padding-right: -10px;padding-right: 0px;padding-left: 0px;"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>조회수 ${board.viewcnt}</th>
