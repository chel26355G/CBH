	...
	<nav class=" navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/bbs/mobile/m.home">컴백홈</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#section1">메인</a></li>
					<li><a href="#section2">공지사항</a></li>
					<li><a href="../mboard/listhome">게시판</a></li>

					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">MORE <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="/bbs/mobile/m.login.do">로그인</a></li>
							<li><a href="/bbs/mobile/m.joinForm.do">회원가입</a></li>
							<li><a href="/bbs/admin/m.adminlogin.do">관리자모드</a></li>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form name="form" method="post" action="m.insertcustomer.do">
							...
							<table class="table table-hober">
								...
								<div class="form-group">
									<label for="usrname" style="color: gray;"><span
										...
										placeholder="Enter E-mail" required id="id">
								</div>
								<div class="form-group">
									...
									<textarea class="form-control" rows="4" id="memo" name="memo"
										placeholder="문의내용" required id="id"></textarea>
								</div>
